...
//constructing rejected UI in email
...
<p style="text-align: center; font-weight: bold;">Your OT request for the following date (${formattedDate}) has been rejected by ${setMail}.</p>
